...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="./assets/css/com.css?v=<?php echo $versao; ?>">
    <link rel="stylesheet" href="./assets/css/estilo.css?v=<?php echo $versao; ?>">
    ...
    <script>
      ...
      fbq('init', '5511151402247017');
      fbq('track', 'PageView');
      </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=5511151402247017&ev=PageView&noscript=1"/>
        </noscript>
    <noscript><img height="1" width="1" style="display:none"
  ...
  <body>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js?v=<?php echo $versao; ?>" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js?v=<?php echo $versao; ?>" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
    <script src="./assets/js/com.js?v=<?php echo $versao; ?>"></script>
  </body>
</html>